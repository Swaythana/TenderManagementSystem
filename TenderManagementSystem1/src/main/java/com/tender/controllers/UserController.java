...
public class UserController {
	...
	public ModelAndView doInsertTender(@Valid @ModelAttribute("tenderUserData") UserTender user, BindingResult br) {
		...
		return new ModelAndView("TenderSuccess", "user", ut);
	...
	@GetMapping("/myconfirmBiddings/{sid}")

	public ModelAndView myconfirmbiddingsHandler(@PathVariable Integer sid)  {
		
		List<Confirm> res=cserv.findByUserId(sid);

		ModelAndView mv = new ModelAndView("confirmBiddingList");

		mv.addObject("confirmBiddingData", res);
